...
// Note: La implementacion esta considerando la priority del avion
// Por eso a nivel consigna el Plane esta creado sin Priority en primera instancia
...
// Es monitor porque mezclamos logica Mutex y Condvar (es una combinacion de ambas)
pub struct Airport {
    runways: Mutex<Vec<Runway>>,
    waiting: Mutex<Vec<WaitingPlane>>,
    cond: Condvar,
}
